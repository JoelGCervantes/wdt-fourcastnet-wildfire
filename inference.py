...
def visualize_2D_fields(variables):    
    ...
    fig.tight_layout()
    plt.savefig(output_dir / "sample_2D_fields.png")
...
if __name__ == "__main__":
    ...
    print(f"Saving visualizations to: {output_dir.resolve()}")
    ...
    fig.tight_layout()
    plt.savefig(output_dir / "acc_rmse_metrics.png")
    ...
    print(pred_msl.shape, true_msl.shape) # destandardized forecasted and true msl fields / Modified from true_mls.shape to rue_mls.shape
